                  ...
                  return (
                    ...
                    >
                      {isOff ? (
                        ...
                        hourAppts.map(appt => (
                          <div key={appt.id} className="w-full p-2.5 rounded-xl border text-xs shadow-lg space-y-1 bg-amber-500/10 border-amber-500/40 text-amber-300">
                            <div className="flex justify-between items-start">
                              <div>
                                <div className="font-bold text-xs text-white">{appt.client_name}</div>
                            ...
                            {appt.service_title && (
                              <div className="flex justify-between items-center pt-1 border-t border-zinc-800/60 text-[10px]">
                                <span className="font-semibold text-amber-300 truncate max-w-[100px]">{appt.service_title}</span>
                                <span className="font-bold text-amber-400">{getServicePrice(appt.service_title)}</span>
                              </div>
                            )}
                            <div className="pt-0.5 flex justify-between items-center text-[10px]">
                              ...
                              <span className="bg-amber-500/20 border border-amber-500/50 text-amber-300 font-bold px-1.5 py-0.5 rounded shadow-sm">
                                ✂️ {appt.master_name || 'Мастер'}
                              </span>
                            </div>
                          </div>
                        ))
